...
function IconCloseCircleComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-close-circle`
  };
...
const IconCloseCircle = /*#__PURE__*/_react.default.forwardRef(IconCloseCircleComponent);
