...
function IconFontColorsComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-font-colors`
  };
...
const IconFontColors = /*#__PURE__*/_react.default.forwardRef(IconFontColorsComponent);
