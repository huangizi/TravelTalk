...
function IconLiveBroadcastComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-live-broadcast`
  };
...
const IconLiveBroadcast = /*#__PURE__*/_react.default.forwardRef(IconLiveBroadcastComponent);
