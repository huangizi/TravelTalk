...
function IconExclamationCircleComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-exclamation-circle`
  };
...
const IconExclamationCircle = /*#__PURE__*/_react.default.forwardRef(IconExclamationCircleComponent);
