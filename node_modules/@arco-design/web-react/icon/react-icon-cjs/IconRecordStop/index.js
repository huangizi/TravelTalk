...
function IconRecordStopComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-record-stop`
  };
...
const IconRecordStop = /*#__PURE__*/_react.default.forwardRef(IconRecordStopComponent);
