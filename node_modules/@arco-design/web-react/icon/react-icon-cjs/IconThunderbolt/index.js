...
function IconThunderboltComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-thunderbolt`
  };
...
const IconThunderbolt = /*#__PURE__*/_react.default.forwardRef(IconThunderboltComponent);
