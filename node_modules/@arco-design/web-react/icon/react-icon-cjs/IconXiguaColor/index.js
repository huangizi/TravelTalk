...
function IconXiguaColorComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-xigua-color`
  };
...
const IconXiguaColor = /*#__PURE__*/_react.default.forwardRef(IconXiguaColorComponent);
