...
function IconTiktokColorComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-tiktok-color`
  };
...
const IconTiktokColor = /*#__PURE__*/_react.default.forwardRef(IconTiktokColorComponent);
