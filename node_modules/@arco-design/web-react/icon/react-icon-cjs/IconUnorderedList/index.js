...
function IconUnorderedListComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-unordered-list`
  };
...
const IconUnorderedList = /*#__PURE__*/_react.default.forwardRef(IconUnorderedListComponent);
