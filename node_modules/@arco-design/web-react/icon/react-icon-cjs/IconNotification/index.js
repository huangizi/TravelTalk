...
function IconNotificationComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-notification`
  };
...
const IconNotification = /*#__PURE__*/_react.default.forwardRef(IconNotificationComponent);
