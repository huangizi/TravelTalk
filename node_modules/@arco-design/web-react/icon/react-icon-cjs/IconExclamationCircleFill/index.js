...
function IconExclamationCircleFillComponent(iconProps, ref) {
  const _useContext = (0, _react.useContext)(_context.IconContext),
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-exclamation-circle-fill`
  };
...
const IconExclamationCircleFill = /*#__PURE__*/_react.default.forwardRef(IconExclamationCircleFillComponent);
