...
function IconInfoCircleFillComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-info-circle-fill`
  };
...
const IconInfoCircleFill = /*#__PURE__*/_react.default.forwardRef(IconInfoCircleFillComponent);
