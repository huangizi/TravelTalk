...
function IconAlignCenterComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-align-center`
  };
...
const IconAlignCenter = /*#__PURE__*/_react.default.forwardRef(IconAlignCenterComponent);
