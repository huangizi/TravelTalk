...
function IconStrikethroughComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-strikethrough`
  };
...
const IconStrikethrough = /*#__PURE__*/_react.default.forwardRef(IconStrikethroughComponent);
