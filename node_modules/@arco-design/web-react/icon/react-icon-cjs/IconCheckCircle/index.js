...
function IconCheckCircleComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-check-circle`
  };
...
const IconCheckCircle = /*#__PURE__*/_react.default.forwardRef(IconCheckCircleComponent);
