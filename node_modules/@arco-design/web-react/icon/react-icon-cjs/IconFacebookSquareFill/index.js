...
function IconFacebookSquareFillComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-facebook-square-fill`
  };
...
const IconFacebookSquareFill = /*#__PURE__*/_react.default.forwardRef(IconFacebookSquareFillComponent);
