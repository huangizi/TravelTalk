...
function IconTwitterCircleFillComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-twitter-circle-fill`
  };
...
const IconTwitterCircleFill = /*#__PURE__*/_react.default.forwardRef(IconTwitterCircleFillComponent);
