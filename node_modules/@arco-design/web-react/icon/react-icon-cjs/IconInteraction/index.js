...
function IconInteractionComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-interaction`
  };
...
const IconInteraction = /*#__PURE__*/_react.default.forwardRef(IconInteractionComponent);
