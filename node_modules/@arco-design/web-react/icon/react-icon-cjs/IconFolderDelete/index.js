...
function IconFolderDeleteComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-folder-delete`
  };
...
const IconFolderDelete = /*#__PURE__*/_react.default.forwardRef(IconFolderDeleteComponent);
