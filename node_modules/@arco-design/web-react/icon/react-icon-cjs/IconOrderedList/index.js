...
function IconOrderedListComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-ordered-list`
  };
...
const IconOrderedList = /*#__PURE__*/_react.default.forwardRef(IconOrderedListComponent);
