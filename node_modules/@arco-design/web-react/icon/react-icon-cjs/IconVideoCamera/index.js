...
function IconVideoCameraComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-video-camera`
  };
...
const IconVideoCamera = /*#__PURE__*/_react.default.forwardRef(IconVideoCameraComponent);
