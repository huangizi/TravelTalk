...
function IconCheckSquareComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-check-square`
  };
...
const IconCheckSquare = /*#__PURE__*/_react.default.forwardRef(IconCheckSquareComponent);
