...
function IconFullscreenExitComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-fullscreen-exit`
  };
...
const IconFullscreenExit = /*#__PURE__*/_react.default.forwardRef(IconFullscreenExitComponent);
