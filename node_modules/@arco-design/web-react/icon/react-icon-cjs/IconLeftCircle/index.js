...
function IconLeftCircleComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-left-circle`
  };
...
const IconLeftCircle = /*#__PURE__*/_react.default.forwardRef(IconLeftCircleComponent);
