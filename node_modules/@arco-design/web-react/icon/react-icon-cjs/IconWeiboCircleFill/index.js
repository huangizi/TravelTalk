...
function IconWeiboCircleFillComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-weibo-circle-fill`
  };
...
const IconWeiboCircleFill = /*#__PURE__*/_react.default.forwardRef(IconWeiboCircleFillComponent);
