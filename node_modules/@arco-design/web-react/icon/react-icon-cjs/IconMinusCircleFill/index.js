...
function IconMinusCircleFillComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-minus-circle-fill`
  };
...
const IconMinusCircleFill = /*#__PURE__*/_react.default.forwardRef(IconMinusCircleFillComponent);
