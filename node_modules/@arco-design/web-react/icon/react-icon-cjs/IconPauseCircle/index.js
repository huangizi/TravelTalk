...
function IconPauseCircleComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-pause-circle`
  };
...
const IconPauseCircle = /*#__PURE__*/_react.default.forwardRef(IconPauseCircleComponent);
