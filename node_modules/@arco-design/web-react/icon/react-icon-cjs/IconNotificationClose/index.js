...
function IconNotificationCloseComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-notification-close`
  };
...
const IconNotificationClose = /*#__PURE__*/_react.default.forwardRef(IconNotificationCloseComponent);
