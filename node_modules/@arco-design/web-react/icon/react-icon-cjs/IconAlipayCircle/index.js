...
function IconAlipayCircleComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-alipay-circle`
  };
...
const IconAlipayCircle = /*#__PURE__*/_react.default.forwardRef(IconAlipayCircleComponent);
