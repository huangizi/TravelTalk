...
function IconQuestionCircleFillComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-question-circle-fill`
  };
...
const IconQuestionCircleFill = /*#__PURE__*/_react.default.forwardRef(IconQuestionCircleFillComponent);
