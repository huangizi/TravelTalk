...
function IconAlignRightComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-align-right`
  };
...
const IconAlignRight = /*#__PURE__*/_react.default.forwardRef(IconAlignRightComponent);
