...
function IconCodeSandboxComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-code-sandbox`
  };
...
const IconCodeSandbox = /*#__PURE__*/_react.default.forwardRef(IconCodeSandboxComponent);
