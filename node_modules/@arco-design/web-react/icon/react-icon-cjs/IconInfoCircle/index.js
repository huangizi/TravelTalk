...
function IconInfoCircleComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-info-circle`
  };
...
const IconInfoCircle = /*#__PURE__*/_react.default.forwardRef(IconInfoCircleComponent);
