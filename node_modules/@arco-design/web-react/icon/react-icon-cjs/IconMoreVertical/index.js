...
function IconMoreVerticalComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-more-vertical`
  };
...
const IconMoreVertical = /*#__PURE__*/_react.default.forwardRef(IconMoreVerticalComponent);
