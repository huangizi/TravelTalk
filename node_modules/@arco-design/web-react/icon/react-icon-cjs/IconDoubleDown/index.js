...
function IconDoubleDownComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-double-down`
  };
...
const IconDoubleDown = /*#__PURE__*/_react.default.forwardRef(IconDoubleDownComponent);
