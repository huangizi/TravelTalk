...
function IconLineHeightComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-line-height`
  };
...
const IconLineHeight = /*#__PURE__*/_react.default.forwardRef(IconLineHeightComponent);
