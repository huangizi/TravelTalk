...
function IconMindMappingComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-mind-mapping`
  };
...
const IconMindMapping = /*#__PURE__*/_react.default.forwardRef(IconMindMappingComponent);
