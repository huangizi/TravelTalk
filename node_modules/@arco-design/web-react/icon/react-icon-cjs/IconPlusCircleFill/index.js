...
function IconPlusCircleFillComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-plus-circle-fill`
  };
...
const IconPlusCircleFill = /*#__PURE__*/_react.default.forwardRef(IconPlusCircleFillComponent);
