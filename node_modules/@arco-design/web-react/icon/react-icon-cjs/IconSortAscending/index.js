...
function IconSortAscendingComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-sort-ascending`
  };
...
const IconSortAscending = /*#__PURE__*/_react.default.forwardRef(IconSortAscendingComponent);
