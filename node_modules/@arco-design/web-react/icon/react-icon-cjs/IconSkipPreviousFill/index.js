...
function IconSkipPreviousFillComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-skip-previous-fill`
  };
...
const IconSkipPreviousFill = /*#__PURE__*/_react.default.forwardRef(IconSkipPreviousFillComponent);
