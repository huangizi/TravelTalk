...
function IconShareInternalComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-share-internal`
  };
...
const IconShareInternal = /*#__PURE__*/React.forwardRef(IconShareInternalComponent);
