...
function IconPauseCircleFillComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-pause-circle-fill`
  };
...
const IconPauseCircleFill = /*#__PURE__*/React.forwardRef(IconPauseCircleFillComponent);
