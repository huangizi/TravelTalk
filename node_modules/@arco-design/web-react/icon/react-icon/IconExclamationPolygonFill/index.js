...
function IconExclamationPolygonFillComponent(iconProps, ref) {
  ...
  const props = {
    ...
    ref,
    ...iconProps,
    className: `${className ? className + ' ' : ''}${prefixCls}-icon ${prefixCls}-icon-exclamation-polygon-fill`
  };
...
const IconExclamationPolygonFill = /*#__PURE__*/React.forwardRef(IconExclamationPolygonFillComponent);
