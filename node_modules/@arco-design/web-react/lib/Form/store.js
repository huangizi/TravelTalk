...
var Store = /** @class */ (function () {
    function Store() {
        ...
        this.resetFields = function (fieldKeys) {
            var prev = (0, utils_1.cloneDeep)(_this.store);
            var fields = (0, is_1.isString)(fieldKeys) ? [fieldKeys] : fieldKeys;
        ...
        this.validate = (0, promisify_1.default)(function (fieldsOrCallback, cb) {
            var callback = function () { };
            var controlItems = _this.getRegisteredFields(true, {
                containFormList: true,
            });
            if ((0, is_1.isArray)(fieldsOrCallback) && fieldsOrCallback.length > 0) {
