...
function Modal(baseProps, ref) {
    ...
    var modalDom = (react_1.default.createElement("div", __assign({ role: "dialog", "aria-modal": "true" }, ariaProps, { className: (0, classNames_1.default)(prefixCls, (_a = {},
            ...
            _a), className), style: style }), innerFocusLock ? (react_1.default.createElement(react_focus_lock_1.default, { crossFrame: false, disabled: !visible, autoFocus: innerAutoFocus, lockProps: {
            tabIndex: -1,
            onKeyDown: onEscExit,
    ...
    return (react_1.default.createElement(Portal_1.default, { visible: visible, forceRender: !mountOnEnter, getContainer: getPopupContainer },
        react_1.default.createElement("div", { ref: ref },
            ...
            react_1.default.createElement("div", __assign({}, (0, omit_1.default)(rest, [
                ...
                'closable',
                'prefixCls',
            ]), { tabIndex: !innerFocusLock || !innerAutoFocus ? -1 : null, ref: modalWrapperRef, className: (0, classNames_1.default)(prefixCls + "-wrapper", (_b = {},
