...
var getPopupStyle_1 = __importDefault(require("./getPopupStyle"));
...
var Trigger = /** @class */ (function (_super) {
    ...
    function Trigger(props, context) {
        ...
        _this.getMergedProps = function (baseProps) {
            ...
            var props = (0, mergeProps_1.default)(baseProps || _this.props, defaultProps, componentConfig === null || componentConfig === void 0 ? void 0 : componentConfig.Trigger);
            return props;
        };
        _this.getRootElement = function () {
            _this.childrenDom = (0, react_dom_1.findDOMNode)(_this);
        ...
        _this.getPopupStyle = function () {
            ...
            var _a = (0, getPopupStyle_1.default)(_this.getMergedProps(), content, child, mountContainer, _this.mouseLocation), style = _a.style, arrowStyle = _a.arrowStyle, realPosition = _a.realPosition;
        ...
        _this.getChild = function () {
            ...
            if (['string', 'number'].indexOf(typeof children) > -1 || react_1.default.Children.count(children) > 1) {
                ...
                child = (react_1.default.createElement("span", { className: element.props.className, style: __assign(__assign({ display: 'inline-block' }, picked), { cursor: 'not-allowed' }) }, react_1.default.cloneElement(element, {
        ...
        _this.triggerPropsEvent = function (eventName, e) {
            ...
            if ((0, is_1.isFunction)(props[eventName])) {
                props[eventName](e);
            }
        };
    ...
    Trigger.prototype.render = function () {
        ...
        var childrenComponent = isExistChildren && (react_1.default.createElement(resizeObserver_1.default, { onResize: this.onResize }, react_1.default.cloneElement(child, __assign({}, mergeProps))));
        var portalContent = (react_1.default.createElement(react_transition_group_1.CSSTransition, { in: !!popupVisible, timeout: duration, classNames: classNames, unmountOnExit: unmountOnExit, appear: true, mountOnEnter: true, onEnter: function (e) {
            ...
            react_1.default.createElement(resizeObserver_1.default, { onResize: function () {
                ...
                react_1.default.createElement("span", __assign({ ref: function (node) { return (_this.triggerRef = node); }, "trigger-placement": this.realPosition, style: __assign(__assign(__assign({ width: autoAlignPopupWidth && (style === null || style === void 0 ? void 0 : style.width) === undefined
        ...
        var portal = popupVisible || this.triggerRef ? (react_1.default.createElement(portal_1.default, { getContainer: this.getContainer }, portalContent)) : null;
