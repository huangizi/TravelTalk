...
var Picker = function (baseProps) {
    ...
    function onChangeInput(e) {
        ...
        if (isValid(niv)) {
            var newValue = (0, dayjs_1.getDayjsValue)(niv, format, utcOffset, timezone);
