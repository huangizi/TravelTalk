...
var InputComponent = react_1.default.forwardRef(function (props, ref) {
    ...
    (0, react_1.useEffect)(function () { return autoFitWidth && updateInputWidth(); }, []);
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        allowClear ? (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            !readOnly && !disabled && allowClear && value ? (react_1.default.createElement(icon_hover_1.default, __assign({ tabIndex: 0, className: prefixCls + "-clear-icon" }, getKeyboardEvents({ onPressEnter: handleClear }), { onClick: function (e) {
                    e.stopPropagation();
                    handleClear(e);
                } }),
                ...
                ? {}
                : __assign(__assign({}, style), ('height' in props ? { height: height } : {})) }))),
        autoFitWidth && (react_1.default.createElement(resizeObserver_1.default, { onResize: function () {
            ...
            react_1.default.createElement("span", { className: prefixCls + "-mirror", ref: refInputMirror }, (0, fillNBSP_1.default)(mirrorValue))))));
});
