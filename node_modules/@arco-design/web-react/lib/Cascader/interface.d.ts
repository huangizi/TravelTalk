 ...
 * @title Cascader
 */
export interface CascaderProps<T = any> extends Omit<SelectViewCommonProps, 'allowCreate' | 'showSearch'> {
    /**
     * @zh 选择框的默认值
     * @en Initial value
     */
...
export declare type InputValueChangeReason = 'manual' | 'optionListHide' | 'optionChecked';
