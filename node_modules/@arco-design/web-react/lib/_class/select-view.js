...
var SelectView = function (props, ref) {
    ...
    var renderSingle = function () {
        ...
        return (react_1.default.createElement("span", { className: prefixCls + "-view-selector" },
            ...
            react_1.default.createElement("span", { className: (0, classNames_1.default)(prefixCls + "-view-value", (_b = {},
                    _b[prefixCls + "-view-value-mirror"] = needShowInput,
                    _b)) }, (0, fillNBSP_1.default)(isEmptyValue ? inputProps.placeholder : _inputValue))));
    };
    var renderMultiple = function () {
        ...
        return (react_1.default.createElement(InputTag_1.default
    ...
    var innerClassNames = (0, classNames_1.default)(prefixCls, prefixCls + "-" + (isMultiple ? 'multiple' : 'single'), (_a = {},
        ...
        _a));
    var dataAttributes = (0, pick_1.pickDataAttributes)(rest);
    ...
    var eleSelectView = (react_1.default.createElement("div", __assign({ role: "combobox", "aria-haspopup": "listbox", "aria-autocomplete": "list", "aria-expanded": popupVisible, "aria-disabled": disabled, "aria-controls": ariaControls }, (0, include_1.default)(rest, ['onClick', 'onMouseEnter', 'onMouseLeave']), { ref: refWrapper, tabIndex: disabled ? -1 : 0, style: needWrapper ? undefined : style }, (needWrapper ? {} : propsAppendToRoot), { className: needWrapper ? innerClassNames : (0, classNames_1.default)(innerClassNames, propsAppendToRoot.className), 
    ...
    return (react_1.default.createElement("div", __assign({}, propsAppendToRoot, { className: (0, classNames_1.default)(prefixCls + "-wrapper", (_c = {},
...
var SelectViewComponent = react_1.default.forwardRef(exports.SelectView);
