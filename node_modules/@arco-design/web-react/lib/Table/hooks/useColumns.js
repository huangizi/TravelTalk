...
var useComponent_1 = __importDefault(require("./useComponent"));
...
function useColumns(props) {
    ...
    var rows = (0, react_1.useMemo)(function () { return getFlattenColumns(columns, childrenColumnName); }, [columns, childrenColumnName]);
    ...
    var _c = (0, useComponent_1.default)(components), getHeaderComponentOperations = _c.getHeaderComponentOperations, getBodyComponentOperations = _c.getBodyComponentOperations;
    var headerOperations = (0, react_1.useMemo)(function () {
    ...
    var bodyOperations = (0, react_1.useMemo)(function () {
    ...
    var getInternalColumns = (0, react_1.useCallback)(function (rows, operations, index) {
        ...
        var expandColumn = shouldRenderExpandCol && {
            key: constant_1.INTERNAL_EXPAND_KEY,
            title: constant_1.INTERNAL_EXPAND_KEY,
            width: expandColWidth,
            $$isOperation: true,
        };
        var selectionColumn = shouldRenderSelectionCol && {
            key: constant_1.INTERNAL_SELECTION_KEY,
            title: constant_1.INTERNAL_SELECTION_KEY,
    ...
    var flattenColumns = (0, react_1.useMemo)(function () { return getInternalColumns(rows, bodyOperations); }, [rows, getInternalColumns, bodyOperations]);
    // 把表头分组的 columns 分成 n 行，并且加上 colSpan 和 rowSpan，没有表头分组的话是 1 行。
    var rowCount = (0, react_1.useMemo)(function () { return getAllHeaderRowsCount(columns, childrenColumnName); }, [columns, childrenColumnName]);
    // 分行之后的rows
    var groupColumns = (0, react_1.useMemo)(function () {
