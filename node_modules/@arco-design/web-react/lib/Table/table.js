...
function Table(baseProps, ref) {
    ...
    var _j = __read((0, react_1.useState)(1), 2), currentPage = _j[0], setCurrentPage = _j[1];
    var _k = __read((0, react_1.useState)(mergePagination.pageSize || mergePagination.defaultPageSize || 10), 2), innerPageSize = _k[0], setInnerPageSize = _k[1];
    var _l = __read((0, react_1.useState)(currentFilters), 2), filters = _l[0], setFilters = _l[1];
    var _m = __read((0, react_1.useState)(currentSorter), 2), sorter = _m[0], setSorter = _m[1];
    var _o = __read((0, react_1.useState)(0), 2), tableViewWidth = _o[0], setTableViewWidth = _o[1];
    var _p = __read((0, useColumns_1.default)(props), 2), groupColumns = _p[0], flattenColumns = _p[1];
    ...
    var _r = (0, useComponent_1.default)(components), ComponentTable = _r.ComponentTable, ComponentBodyWrapper = _r.ComponentBodyWrapper, ComponentHeaderWrapper = _r.ComponentHeaderWrapper;
    ...
    var controlledSorter = (0, react_1.useMemo)(function () {
    ...
    var _t = __read((0, useExpand_1.default)(props, flattenData, getRowKey), 2), expandedRowKeys = _t[0], onClickExpandBtn = _t[1];
    var scrollStyleY = {};
    var scrollStyleX = {};
    if (scroll) {
    ...
    return (react_1.default.createElement("div", __assign({ ref: refTable, style: style, className: classNames }, (0, pick_1.pickDataAttributes)(props)),
        react_1.default.createElement(Spin_1.default, __assign({ element: loadingElement || react_1.default.createElement(Spin_1.default, null) }, loading),
