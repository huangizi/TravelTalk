...
function InputTag(baseProps, ref) {
    ...
    var _c = __read((0, react_1.useState)(false), 2), focused = _c[0], setFocused = _c[1];
    ...
    var mergedRenderTag = function (item, index) {
        ...
        return (react_1.default.createElement(Tag_1.default, { visible: true, className: (0, classNames_1.default)(prefixCls + "-tag", (_a = {},
                _a[tagClassName] = tagClassName,
                _a)), closable: closable, closeIcon: icon && icon.removeIcon, title: typeof label === 'string' ? label : undefined, onClose: onClose, onMouseDown: keepFocus }, (0, fillNBSP_1.default)(label)));
    };
    var handleTokenSeparators = function (str, isPaste) {
    ...
    return (react_1.default.createElement("div", __assign({}, (0, omit_1.default)(rest, ['status', 'size', 'defaultValue', 'value', 'inputValue']), { style: style, className: (0, classNames_1.default)(prefixCls, (_a = {},
