...
function Base(props) {
    ...
    var _b = __read((0, react_1.useState)(false), 2), editing = _b[0], setEditing = _b[1];
    var _c = __read((0, react_1.useState)(0), 2), width = _c[0], setWidth = _c[1];
    var resizeTime = (0, react_1.useRef)(0);
    ...
    var _e = (0, useCssEllipsis_1.default)(ellipsisConfig), simpleEllipsis = _e.simpleEllipsis, ellipsisStyle = _e.ellipsisStyle;
    ...
    var _f = (0, useEllipsis_1.default)(__assign(__assign({}, ellipsisConfig), { children: children, expanding: expanding, width: width, renderMeasureContent: renderMeasureContent, simpleEllipsis: simpleEllipsis || expanding })), ellipsisNode = _f.ellipsisNode, isEllipsis = _f.isEllipsis, measureStatus = _f.measureStatus;
    ...
    return mergedEditing ? (react_1.default.createElement(edit_content_1.default, __assign({}, props, { prefixCls: prefixCls, setEditing: setEditing, editableConfig: editableConfig }))) : (renderContent());
}
