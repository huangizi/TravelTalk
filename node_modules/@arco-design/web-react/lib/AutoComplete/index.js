...
function AutoComplete(baseProps, ref) {
    ...
    var TriggerElement = react_1.default.cloneElement(usedTriggerElement, __assign(__assign(__assign({ ref: function (node) {
        ...
        suffix: loading ? react_1.default.createElement(IconLoading_1.default, null) : (inputProps === null || inputProps === void 0 ? void 0 : inputProps.suffix) || react_1.default.createElement("i", null), onFocus: function (event) {
            var _a;
            setIsFocused(true);
