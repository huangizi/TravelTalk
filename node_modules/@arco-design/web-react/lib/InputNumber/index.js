...
function InputNumber(baseProps, ref) {
    var _a;
    var _b;
    var _c = (0, react_1.useContext)(ConfigProvider_1.ConfigContext), getPrefixCls = _c.getPrefixCls, ctxSize = _c.size, componentConfig = _c.componentConfig;
    ...
    var handleArrowKey = function (event, method, needRepeat) {
        ...
        var finalValue = value.isInvalid
            ? (0, Decimal_1.getDecimal)(min === -Infinity ? 0 : min)
    ...
    var inputEventHandlers = {
        onChange: function (rawText, event) {
            ...
            if ((0, is_1.isNumber)(+parsedValue) || parsedValue === '-' || !parsedValue || parsedValue === '.') {
                ...
                setValue(getLegalValue((0, Decimal_1.getDecimal)(parsedValue)));
