...
export declare type OptionsType = SelectProps['options'];
export declare type InputValueChangeReason = 'manual' | 'optionChecked' | 'optionListHide' | 'tokenSeparator';
...
export declare type LabeledValue = {
    value: string | number;
    label: ReactNode;
};
export declare type SelectInnerStateValue = string | number | string[] | number[];
/**
 * @title Select
 */
 ...
 */
export declare type SelectHandle = {
    /**
     * @zh DOM 节点
     * @en DOM
     */
